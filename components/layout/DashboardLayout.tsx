    ...
    const checkAuth = async () => {
      try {
        ...
        const roleDefaultPages = {
          ...
          supplier: ['/products', '/purchase-orders', '/production', '/payments', '/supplier-performance', '/dashboard'],
          warehouse: ['/warehouse-orders', '/inventory', '/locations', '/purchase-orders', '/dashboard'],
          carrier: ['/carrier', '/dashboard'],
          factory: ['/factory-production', '/manufacturing', '/quality-control', '/dashboard'],
          admin: ['/admin', '/orders', '/products', '/inventory', '/warehouses', '/purchase-orders', '/production', '/returns', '/payments', '/supplier-performance', '/carriers', '/carrier', '/reports', '/dashboard', '/shop', '/checkout']
        };
